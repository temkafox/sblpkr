...
export const CLIENT_SET_NEXT_HAND_READY = 'CLIENT_SET_NEXT_HAND_READY' as const;
export const CLIENT_PLAYER_ACTION = 'CLIENT_PLAYER_ACTION' as const;
export const CLIENT_SEND_CHAT_MESSAGE = 'CLIENT_SEND_CHAT_MESSAGE' as const;
export const CLIENT_REQUEST_CHAT_MESSAGES = 'CLIENT_REQUEST_CHAT_MESSAGES' as const;
...
export const SERVER_CHAT_MESSAGES = 'SERVER_CHAT_MESSAGES' as const;
export const SERVER_HAND_RESULT = 'SERVER_HAND_RESULT' as const;
export const SERVER_NEXT_HAND_READY_STATE = 'SERVER_NEXT_HAND_READY_STATE' as const;
