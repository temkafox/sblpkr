    ...
    <div className="jr-settings">
      ...
      {expanded ? (
        <div className="jr-settings__body">
          ...
          <div className="jr-settings__scroll">
            <section className="jr-settings__section" aria-label="Basic settings">
              <h3 className="jr-settings__section-title">Basic</h3>

              <div className="jr-settings__row jr-settings__row--2">
                <label className="jr-field jr-field--compact">
                  <span className="jr-field__label">Room name</span>
                  <input
                    className={`jr-field__input jr-field__input--sm${errors.roomName ? ' jr-field__input--error' : ''}`}
                    type="text"
                    maxLength={32}
                    value={form.roomName}
                ...
                <label className="jr-field jr-field--compact">
                  ...
                  <select
                    className="jr-field__input jr-field__input--sm"
                    value={form.maxSeats}
                    onChange={(ev) =>
                      patch({
              ...
              <div className="jr-settings__grid">
                <label className="jr-field jr-field--compact">
                  ...
                  <input
                    className={`jr-field__input jr-field__input--sm${errors.startingStack ? ' jr-field__input--error' : ''}`}
                    type="number"
                    min={1}
                ...
                <label className="jr-field jr-field--compact">
                  ...
                  <input
                    className={`jr-field__input jr-field__input--sm${errors.smallBlind ? ' jr-field__input--error' : ''}`}
                    type="number"
                    min={1}
                ...
                <label className="jr-field jr-field--compact">
                  ...
                  <input
                    className={`jr-field__input jr-field__input--sm${errors.bigBlind ? ' jr-field__input--error' : ''}`}
                    type="number"
                    min={1}
                    placeholder="2× SB"
                    value={form.bigBlind}
                ...
                <label className="jr-field jr-field--compact">
                  ...
                  <input
                    className={`jr-field__input jr-field__input--sm${errors.rebuyAmount ? ' jr-field__input--error' : ''}`}
                    type="number"
                    min={1}
              ...
              <div className="jr-settings__rebuys">
                ...
                {!form.maxRebuysUnlimited ? (
                  <label className="jr-field jr-field--compact jr-settings__rebuy-max">
                    <span className="jr-field__label">Max rebuys</span>
                    <input
                      className={`jr-field__input jr-field__input--sm${errors.maxRebuys ? ' jr-field__input--error' : ''}`}
                      type="number"
                      min={0}
            ...
            <button
              type="button"
              className="jr-settings__advanced-toggle"
            ...
            {advancedExpanded ? (
              <section
                className="jr-settings__section jr-settings__section--advanced"
              ...
              >
                <div className="jr-settings__grid">
                  <label className="jr-field jr-field--compact">
                    ...
                    <input
                      className={`jr-field__input jr-field__input--sm${errors.actionTimeoutSeconds ? ' jr-field__input--error' : ''}`}
                      type="number"
                      min={5}
                      max={120}
                  ...
                  <label className="jr-field jr-field--compact">
                    ...
                    <input
                      className={`jr-field__input jr-field__input--sm${errors.disconnectGraceSeconds ? ' jr-field__input--error' : ''}`}
                      type="number"
                      min={5}
                      max={120}
          ...
          <button
            type="button"
            className="jr-btn jr-btn--ghost jr-btn--sm jr-settings__reset"
